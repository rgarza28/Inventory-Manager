         ...
         <AppBar className={classes.appBarStyle} color="secondary" position="fixed">
            <Toolbar>
               <Grid xs>
                  ...
                  <Button className={classes.textButtonStyle} href="#features">features</Button> 
                  <Button className={classes.textButtonStyle} href="#industries">industries</Button> 
                  <Button className={classes.textButtonStyle} href="#customers">customers</Button> 
                  <Button className={classes.textButtonStyle} href="#pricing">pricing</Button> 
                  <Button className={classes.textButtonStyle} href="#team">team</Button> 
