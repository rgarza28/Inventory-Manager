...
import { AppBar, Box, Button, Avatar, Grid, Container, Link } from '@material-ui/core';
						...
						<Box className={classes.boxStyle}>
							{userData.token ? (
								<>
									...
									<Button className={classes.containedButtonStyle} variant='text' onClick={logout}>
										sign out
									</Button>
								</>
							) : (
								<>
									<Button className={classes.textButtonStyle} variant='text' onClick={signin}>
										sign in
									</Button>
									<Button className={classes.containedButtonStyle} variant='text' onClick={signup}>
										get started
									</Button>
								</>
							)}
